...
// Encode ...
func (inst *JWTCodec) Encode(t1 *sejwt.Token) (sejwt.Text, error) {
...
// Decode ...
func (inst *JWTCodec) Decode(t1 sejwt.Text) (*sejwt.Token, error) {
...
func (inst *JWTCodec) verify(o *sejwt.Token) error {
	now := lang.Now()
	t1 := o.CreatedAt
	t2 := o.ExpiredAt
	if now < t1 || t2 < now {
